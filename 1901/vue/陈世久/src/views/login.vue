    ...
    <div class="denglu">
        ...
        <mt-tab-container v-model="selected">
            <mt-tab-container-item id="login">
                 <mt-field label="用户名" placeholder="请输入用户名" v-model="loginInfo.username" id="username"></mt-field>
                 <mt-field label="密码" placeholder="请输入密码" type="password" v-model="loginInfo.pwd" id="userpwd"></mt-field>
...
export default {
    ...
    methods:{
		...
		register(){
			this.$axios.post("/vue/register",this.rigisterInfo)
			.then(res=>{
				this.selected="login"
				})	
