...
export default {
  ...
  data() {
    return {
      ...
      sms: "",
      loginInfo: {
        username:window.sessionStorage.username?window.sessionStorage.username.replace(/\"/g, ""):'',
        // username:'',
        password:'',
      },
      rigisterInfo: {},
  ...
  created(){
    if(window.sessionStorage.userInfo){
      // this.loginInfo.username = window.sessionStorage.username,
      // console.log(this.loginInfo.username.replace(/\"/g, "")),
       ...
       if(this.loginInfo.username && this.loginInfo.password && this.nxetlogin ) {         
        ...
        .then(res=>{
          ...
          if(!!res.data.type){
              ...
              window.sessionStorage.username = JSON.stringify(res.data.result.username);
              // window.sessionStorage.username = JSON.stringify({username:res.data.result.username});
