...
export default {
    data(){
        return {
            userInfo: {
              touxiang: require("../assets/images/f3.png"),
     ...
     methods:{
        seen(){
            ...
            this.url = userInfo.icon.replace(/public/,'http://101.132.73.191:1812');
        },
        updateimg() {
            // console.log("上传图片");
        ...
        shangchuan(e) {
            ...
            this.$axios({
                ...
                // console.log(res);
                this.userInfo.touxiang  = res.data.imgUrl.replace(/public/,'http://101.132.73.191:1812');
