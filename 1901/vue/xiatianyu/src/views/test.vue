<template>
  <div>
    <van-checkbox-group class="card-goods" v-model="checkedGoods">
      <van-checkbox class="card-goods__item" v-for="item in goods" :key="item.id" v-model="danchecked" :name="item.id">
        <van-card
          :title="item.title"
          :desc="item.desc"
          :num="item.num"
...
export default {
  ...
  mounted(){
    var arr = [1,2,3,4]
    var b = arr.reduce((pre,cur,index)=>{
